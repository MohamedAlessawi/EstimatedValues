...
export const ProfileIcon = createIcon({
    ...
    path: (
        <g>
            ...
            <path
                fill="currentColor"
                d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v1c0 .55.45 1 1 1h14c.55 0 1-.45 1-1v-1c0-2.66-5.33-8-8-8z"
            />
        </g>
    ),
});
...
export const WalletIcon = createIcon({
    ...
    path: (
        <g>
            <path
                fill="currentColor"
                d="M4.447 4.818h14.062c.164 0 .328.01.491.031a2.9 2.9 0 00-3.406-2.441L4.03 4.382h-.013a2.9 2.9 0 00-1.805 1.149 3.848 3.848 0 012.236-.713zM18.51 5.875H4.446a2.816 2.816 0 00-2.813 2.812v8.438a2.816 2.816 0 002.813 2.812h14.062a2.815 2.815 0 002.813-2.813V8.687a2.815 2.815 0 00-2.813-2.812zm-2.088 8.437a1.406 1.406 0 110-2.811 1.406 1.406 0 010 2.811z"
            />
            <path
                fill="currentColor"
...
export const CalendarIcon = (props) => (
    <Icon viewBox="0 0 24 24" {...props}>
        <path
            d="M19,19H8V8h11M19,3H18V1H16V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3M10,17H8V14H10V17M14,17H12V14H14V17M18,17H16V14H18V17M10,13H8V10H10V13M14,13H12V10H14V13M18,13H16V10H18V13Z"
            fill="currentColor"
        />
    </Icon>
);
...
export const MoneyIcon = (props) => (
    <Icon viewBox="0 0 24 24" {...props}>
        <path
            d="M5,6H23V18H5V6M9,8A2,2 0 0,1 7,10V14A2,2 0 0,1 9,16H19A2,2 0 0,0 21,14V10A2,2 0 0,0 19,8H9M1,10H3V20H19V22H1V10Z"
            fill="currentColor"
        />
    </Icon>
);
...
export const ChartIcon = (props) => (
    <Icon viewBox="0 0 24 24" {...props}>
        <path
            d="M2,11A1,1 0 0,1 3,10H5A1,1 0 0,1 6,11V17A1,1 0 0,1 5,18H3A1,1 0 0,1 2,17V11M9,4A1,1 0 0,1 10,3H14A1,1 0 0,1 15,4V17A1,1 0 0,1 14,18H10A1,1 0 0,1 9,17V4M16,9A1,1 0 0,1 17,8H21A1,1 0 0,1 22,9V17A1,1 0 0,1 21,18H17A1,1 0 0,1 16,17V9Z"
            fill="currentColor"
        />
    </Icon>
);
